...
% Choose the NACA profile, panelization, Angle of Attack and Chord
% Input data: 
...
title('C_p Distribution','FontSize',24);                     %,naca_string);
xlabel('Normalized length of the wing','FontSize',22);
ylabel('-C_p','FontSize',22);
